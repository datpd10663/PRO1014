...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 10, 2024 lúc 10:01 AM
...
(1, 1, 20, 'ngon ', NULL, '2024-12-08 06:56:25'),
...
(23, 1, 'Nguyễn Lê Tiến Đạt', 'nguyenletiendat63@gmail.com', '42f13762094135b7a67438b788950ed6b0aaabd687b992a3a206547e84ac57e1', '0973793847', 'Đà Nẵng');
...
--
ALTER TABLE `invoice_detail`
  MODIFY `invoice_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
ALTER TABLE `productdetail`
  MODIFY `product_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;
...
--
ALTER TABLE `productdetail`
  ADD CONSTRAINT `productdetail_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`) ON DELETE CASCADE;
