...
<div class="slideshow-container">
    <div class="mySlides slide-left">
        <img src="https://hcm.fstorage.vn/images/2024/09/web_1920x576px-20240916030803.jpg" style="width:100%; height:500px;">
    </div>
    
    <div class="mySlides slide-left">
        <img src="https://hcm.fstorage.vn/phuclong/2024/11/z6025323572747_04c1789072a3dc261814ffecf4de5c03-20241112111018.jpg" style="width:100%; height:500px;">
    </div>
    
    <div class="mySlides slide-left">
        <img src="https://hcm.fstorage.vn/images/2024/07/website_kv_1280x543px_copy-20240729065159.jpg" style="width:100%; height:500px;">
    </div>
</div>
...
<div class="content">
    ...
    <div class="product-card">
        ...
        <a href="./views/chitietsanpham/chitiet.php?id=<?php echo $product['product_id']; ?>">
            <img src="./control/<?php echo $product['address']; ?>" style="padding-left: 35px;">
        </a>
        ...
        <div class="description">
            ...
            <button class="btn-order" onclick="orderSuccess()">🛒 Đặt mua</button>
        </div>
    </div>
<?php } ?>
